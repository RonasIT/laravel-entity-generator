...
class NovaPostTest extends TestCase
{
    ...
    public static function getPostActionsData(): array
    {
        return [
            [
                'resources' => [1, 2],
                'fixture' => 'get_post_actions_publish_post_action',
            ],
            [
                'resources' => [1, 2],
                'fixture' => 'get_post_actions_un_publish_post_action',
            ],
        ];
    }
